...
class TreeNode {
  public:
    ...
    void preorder(bool first = true) { TreeNode::preorder(this); }
    ...
    void inorder(bool first = true) { TreeNode::inorder(this); }
    ...
    void postorder(bool first = true) { TreeNode::postorder(this); }
